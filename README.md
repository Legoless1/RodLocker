...
Requires Winch 0.6.2 or newer.

## Install

Install `legoless.RodLocker.zip` with the DREDGE Mod Manager.

Manual install: extract the zip into DREDGE's `Mods` folder so that `mod_meta.json` is inside `Mods\legoless.RodLocker`.
